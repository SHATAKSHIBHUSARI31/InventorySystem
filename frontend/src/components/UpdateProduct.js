...
export default function UpdateProduct({ updateProductData, updateModalSetting }) {
  const [product, setProduct] = useState({ ...updateProductData });
  ...
  const updateProduct = () => {
    // Simulate API update here
    alert("Product updated successfully!");
    updateModalSetting(); // Close modal
  };
                      ...
                      <div className="mt-2">
                        <form>
                          <div className="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                              <label className="block text-sm font-medium text-gray-700">Critical Low Threshold</label>
                              <input
                                type="number"
